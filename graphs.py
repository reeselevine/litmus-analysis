...
def figure1():
    ...
    si_no_stress_means = take_log([0, 0, 0, 0, 0, 0, 0, 0, 9.693, 0.123, 0, 35.679])
    ...
    parallel_no_stress_means = take_log([3.628, 26.284, 316.912, 85.317, 47.859, 111.277, 990.374, 254.645, 8007.971, 15160.747, 354670.514, 13745.04])
    ...
    si_weak_caught = take_pct([13, 8, 6, 0], 18)
    si_weak_co_caught = take_pct([6, 4, 6, 0], 6)
    si_co_caught = take_pct([8, 5, 8, 6], 8)
    si_all_caught = take_pct([27, 17, 20, 6], 32)
    ...
    ax5.bar(x - 1.5 * width, si_no_stress_means[8:12], width)
    ax5.bar(x - .5 * width, si_means[8:12], width)
    ax5.bar(x + .5 * width, parallel_no_stress_means[8:12], width)
    ax5.bar(x + 1.5 * width, parallel_means[8:12], width)
    ax5.set_ylim([0, 6])
    ax5.set_xticks(x, labels)
    ax6.bar(x - 1.5 * width, si_no_stress_means[4:8], width)
    ax6.bar(x - .5 * width, si_means[4:8], width)
    ax6.bar(x + .5 * width, parallel_no_stress_means[4:8], width)
    ax6.bar(x + 1.5 * width, parallel_means[4:8], width)
    ax6.set_ylim([0, 6])
    ax6.set_xticks(x, labels)
    ax7.bar(x - 1.5 * width, si_no_stress_means[0:4], width, label="Single Instance No Stress")
    ax7.bar(x - .5 * width, si_means[0:4], width, label="Single Instance")
    ax7.bar(x + .5 * width, parallel_no_stress_means[0:4], width, label="Parallel No Stress")
    ax7.bar(x + 1.5 * width, parallel_means[0:4], width, label="Parallel")
    ax7.set_ylim([0, 6])
